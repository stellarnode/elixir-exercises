defmodule SequenceSupervisor.Supervisor do
  use Supervisor
  ...
  def start_workers(sup, initial_number) do
    ...
    { :ok, stash } = Supervisor.start_child(sup, worker(SequenceSupervisor.Stash, [initial_number]))
    # and then the subsupervisor for the actual sequence server
    Supervisor.start_child(sup, supervisor(SequenceSupervisor.SubSupervisor, [stash]))
  end
